export const projetsEcole = [
  ...
  {
    titre: 'TPLC',
    sousTitre: 'Touche Pas La Covid',
    date: 'Janvier 2022',
    description: 'Réalisation d\'une copie de l\'application mobile TousAntiCovid, ' +
  ...
  },
  {
    ...
    sousTitre: 'Projet de Théorie des langages',
    date: 'Décembre 2021',
  ...
  {
    titre: 'Stratego',
    sousTitre: 'Projet de JavaScript',
  ...
  },
  {
    ...
    sousTitre: 'Projet de C++',
    date: 'Décembre 2020',
    description: 'Réalisation d\'une simulation de marathon, avec une interface graphique permettant de voir ' +
  ...
  {
    titre: 'Santé',
    sousTitre: 'CIRious Game de deuxième année sur le thème de la santé et du handicap',
    date: 'Avril / Mai 2020',
    description: 'Création d\'un jeu Web visant à sensibiliser le joueur à différents handicaps.\n' +
